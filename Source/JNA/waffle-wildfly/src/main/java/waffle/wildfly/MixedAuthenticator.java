 ...
 */
public class MixedAuthenticator extends WaffleAuthenticator {
...
//            this.redirectTo(request, response, loginConfig.getLoginPage());
     ...
     * @return true, if successful
     */
    private boolean negotiate(final HttpServletRequest request, final HttpServletResponse response,
...
//            this.register(request, response, windowsPrincipal, securityPackage, windowsPrincipal.getName(), null);
     ...
     * @return true, if successful
     */
    private boolean post(final HttpServletRequest request, final HttpServletResponse response) {
...
//            this.register(request, response, windowsPrincipal, "FORM", windowsPrincipal.getName(), null);
     ...
     *            the url
     */
    private void redirectTo(final HttpServletRequest request, final HttpServletResponse response, final String url) {
//        try {
