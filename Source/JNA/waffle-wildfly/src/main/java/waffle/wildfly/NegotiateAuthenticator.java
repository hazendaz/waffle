 ...
 */
public class NegotiateAuthenticator extends WaffleAuthenticator {
    ...
    public NegotiateAuthenticator() {
        ...
        this.info = "waffle.wildfly.NegotiateAuthenticator/1.0";
        this.log.debug("[waffle.wildfly.NegotiateAuthenticator] loaded");
    }
